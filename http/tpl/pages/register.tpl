...
<div class="log_form">
		...
		<form action="index.php?page=json&action=register" name="formAuth" method = "post">
		<table border=0 align=right>
			<tr height=26 valign=top>
			<td width=140 align=right><b>Имя пользователя:</b></td>
			...
			<!--<td colspan=2>-->
			<td></td><td><input type="submit" name="button" value="Зарегистрироваться"></td>
			</tr>
		</table>
		</form>
		<br />
